...
//  FuelBarTestApp
//
//  Created by Sherman Shi on 6/19/19.
...
class HomeHeaderView: UICollectionReusableView {
    ...
    func configureViewComponents() {
        ...
        containerView.anchorwithConstant(top: self.topAnchor, bottom: nil, leading: self.leadingAnchor, trailing: self.trailingAnchor, paddingTop: -100, paddingBottom: 0, paddingLeading: 0, paddingTrailing: 0, width: 0, height: 400)
        
        containerView.addSubview(profileImageView)
        profileImageView.centerXAnchor.constraint(equalTo: self.centerXAnchor).isActive = true
        profileImageView.anchorwithConstant(top: self.topAnchor, bottom: nil, leading: nil, trailing: nil, paddingTop: 100, paddingBottom: 0, paddingLeading: 0, paddingTrailing: 0, width: 120, height: 120)
